...
export function RetrievalWorkspace({
  ...
  const TRANSLATIONS = {
    ...
    mr: {
      ...
      strictSynthesisMode: "कठोर संश्लेषण मोड लागू (चुकीच्या उत्तरांवर बंदी)",
      destinationContext: "गंतव्य संदर्भ",
      filedDraft: "दाखल मसुदा (पडताळणी चालू)",
      draftEditor: "मसुदा संपादक (पडताळणी बंद)",
      verificationTitle: "पडताळणी गेट",
      verifyingCitations: "मूळ दस्तऐवज मजकुराशी संदर्भांची पडताळणी करत आहे...",
      citationVerifySummary: "संदर्भ पडताळणी सारांश",
      passedCount: "यशस्वी",
      failedCount: "अयशस्वी",
      verifyPassDesc: "सर्व संदर्भ पडताळले. फाईल सादर करणे सुरक्षित आहे.",
      verifyFailDesc: "संदर्भ पडताळणी अयशस्वी! मसुद्यातील काही युक्तिवाद प्राप्त झालेल्या माहितीशी जुळत नाहीत. कृपया मसुदा सुधारा.",
      provenanceTitle: "उगम आणि अंमलबजावणी नोंद",
      provenanceStep: "टप्पा {step}",
      provenanceLog: "उगम नोंद",
    },
    bn: {
      workspaceTitle: "আইনি বুদ্ধিমত্তা ইঞ্জিন",
      workspaceSub: "পাবলিক এবং প্রাইভেট কর্পাস জুড়ে মাল্টি-এজেন্ট আরএজি অনুসন্ধান।",
      search: "অনুসন্ধান",
      history: "ইতিহাস",
      sourcesLabel: "উৎস:",
      publicCorpusPill: "পাবলিক কর্পাস (সুপ্রিম কোর্ট)",
      privateCorpusPill: "ব্যক্তিগত চেম্বার নথি",
      advancedFilters: "উন্নত ফিল্টার",
      startSessionTitle: "গবেষণা সেশন শুরু করুন",
      startSessionDesc: "উকিল সঠিক উত্তর সংশ্লেষণ করতে হাজার হাজার যাচাইকৃত রায় এবং আপনার ব্যক্তিগত চেম্বারের তথ্যভাণ্ডার অনুসন্ধান করে।",
      connected: "ইকানুন সোর্স সংযুক্ত",
      routerTitle: "রাউটার এবং প্ল্যানার এজেন্ট",
      routerClass: "রাউটিং শ্রেণীবিভাগ",
      confidence: "আত্মবিশ্বাস সূচক",
      publicCorpus: "পাবলিক কর্পাস",
      publicCorpusDesc: "भारतीय कानून / मामला আইন",
      privateCorpus: "ব্যক্তিগত কর্পাস",
      privateCorpusDesc: "চেম্বার নথি",
      bothCorpora: "উভয় কর্পাস",
      bothCorporaDesc: "ডিফল্ট ফলব্যাক",
      retrievalTitle: "ভেক্টর রিট্রিভাল ফলাফল",
      topChunks: "শীর্ষ-{count} অংশ",
      securityEnforced: "নিরাপত্তা বলবৎ করা হয়েছে:",
      confidentialFiltered: "is_private: true চিহ্নিত গোপনীয় ফাইলগুলি বর্তমান ইন্টার্ন ভূমিকার জন্য ফিল্টার করা হয়েছে।",
      noMatchingChunks: "কোনো প্রাসঙ্গিক অংশ পাওয়া যায়নি। অন্য প্রশ্ন চেষ্টা করুন বা রোল সেটিংস পরিবর্তন করুন।",
      poweredByKanoon: "ইকানুন দ্বারা চালিত",
      verifyPass: "যাচাই: সফল",
      verifyFailed: "যাচাই: ব্যর্থ",
      pendingVerify: "যাচাই পেন্ডিং",
      publicCorpusBadge: "পাবলিক কর্পাস",
      chamberFileBadge: "চেম্বার ফাইল",
      synthesisTitle: "সংশ্লেষণ এজেন্ট",
      strictSynthesisMode: "কঠোর সংশ্লেষণ মোড বলবৎ (কোনো মনগড়া উত্তর নয়)",
      destinationContext: "গন্তব্য প্রসঙ্গ",
      filedDraft: "দাখিলকৃত খসড়া (যাচাই চালু)",
      draftEditor: "খসড়া সম্পাদক (যাচাই বন্ধ)",
      verificationTitle: "যাচাইকরণ গেট",
      verifyingCitations: "মূল নথির সাথে উদ্ধৃতি যাচাই করা হচ্ছে...",
      citationVerifySummary: "উদ্ধৃতি যাচাইকরণ সারাংশ",
      passedCount: "সফল",
      failedCount: "ব্যর্থ",
      verifyPassDesc: "সমস্ত উদ্ধৃতি যাচাই করা হয়েছে। ফাইলটি সাবমিট করা নিরাপদ।",
      verifyFailDesc: "উদ্ধৃতি যাচাইকরণ ব্যর্থ হয়েছে! খসড়া টেক্সটটিতে এমন কিছু যুক্তি রয়েছে যা সংগৃহীত রেফারেন্সের সাথে সামঞ্জস্যপূর্ণ নয়। দয়া করে খসড়াটি সংশোধন করুন।",
      provenanceTitle: "উৎস এবং এক্সিকিউশন লগ",
      provenanceStep: "ধাপ {step}",
      provenanceLog: "উৎস লগ",
    }
  };
